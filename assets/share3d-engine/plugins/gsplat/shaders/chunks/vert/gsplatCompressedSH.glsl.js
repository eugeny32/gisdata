const gsplatCompressedSH_glsl_rslib_entry_ = `// ============================================================
// GSplat Compressed SH - 压缩格式 SH 读取
// 对标 PlayCanvas gsplatCompressedSH.js
// ============================================================
...
vec4 unpack8888s(in uint bits) {
  return vec4((uvec4(bits) >> uvec4(0u, 8u, 16u, 24u)) & uvec4(0xffu)) * (8.0 / 255.0) - 4.0;
}

// 压缩格式仅实现 band 3（15 个系数），保持签名一致
...
#endif
`;
export { gsplatCompressedSH_glsl_rslib_entry_ as default };
