...
class ArcObjectManager extends __WEBPACK_EXTERNAL_MODULE__BaseObjectManager_js_cb8c9cc7__.BaseObjectManager {
    createObject(entity) {
    ...
    getCachedGeometryKey(entity) {
        const segmentsNum = this.resolveSegmentsNum(entity);
        return `${entity.radius}_${entity.startAngle}_${entity.endAngle}_${entity.clockwise}_${segmentsNum}`;
    }
    ...
    createGeometry(entity) {
        const segmentsNum = this.resolveSegmentsNum(entity);
        const points = __WEBPACK_EXTERNAL_MODULE__utils_DrawUtils_js_5dc4c073__.DrawUtils.getArcPoints({
    ...
    resolveSegmentsNum(entity) {
        const sweepAngle = __WEBPACK_EXTERNAL_MODULE__utils_ArcUtils_js_38ae85a5__.ArcUtils.getSweepAngle(entity.startAngle, entity.endAngle, entity.clockwise);
        const segmentsNum = __WEBPACK_EXTERNAL_MODULE__utils_ArcUtils_js_38ae85a5__.ArcUtils.getStaticSegments(entity.radius, sweepAngle);
        entity.segmentsNum = segmentsNum;
        return segmentsNum;
    }
    constructor(...args){
