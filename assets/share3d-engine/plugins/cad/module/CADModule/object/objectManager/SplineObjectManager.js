...
class SplineObjectManager extends __WEBPACK_EXTERNAL_MODULE__BaseObjectManager_js_cb8c9cc7__.BaseObjectManager {
    createObject(entity) {
    ...
    onUpdateGeometry(entity) {
        ...
        if (!object) return;
        const points = __WEBPACK_EXTERNAL_MODULE__entityObject_entityObjectUtils_js_415ef2f4__.EntityObjectUtils.getSplineSamplePoints(entity);
        object.geometry.dispose();
        object.geometry = __WEBPACK_EXTERNAL_MODULE__utils_DrawUtils_js_5dc4c073__.DrawUtils.getLineGeometryByPoints(points);
        object.computeLineDistances();
        object.geometry.computeBoundingBox();
        object.geometry.computeBoundingSphere();
    }
