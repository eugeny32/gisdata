...
class CircleObjectManager extends __WEBPACK_EXTERNAL_MODULE__BaseObjectManager_js_cb8c9cc7__.BaseObjectManager {
    createObject(entity) {
    ...
    getCachedGeometryKey(entity) {
        ...
        return `${entity.radius}_${segmentsNum}`;
    }
    ...
    resolveSegmentsNum(entity) {
        const segmentsNum = __WEBPACK_EXTERNAL_MODULE__utils_ArcUtils_js_38ae85a5__.ArcUtils.getStaticSegments(entity.radius, 2 * Math.PI);
