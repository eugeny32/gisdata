...
import * as __WEBPACK_EXTERNAL_MODULE__command_CopyEntityCommand_js_d463eea3__ from "../command/CopyEntityCommand.js";
...
const copyEntityMachine = (0, __WEBPACK_EXTERNAL_MODULE_xstate__.setup)({
    actions: {
        entrySelectEntity: ()=>{},
        exitSelectEntity: ()=>{},
...
class CopyEntityTool extends __WEBPACK_EXTERNAL_MODULE__core_tool_StateMachineTool_js_4ff72ac2__.StateMachineTool {
    onInitialize() {
    ...
    onSelectorChanged(entities) {
        ...
        this.mouseTipHelper.updateTip(__WEBPACK_EXTERNAL_MODULE__auxiliaryTool_MouseTipHelper_js_0b8aa1a1__.MouseTipId.Edit, __WEBPACK_EXTERNAL_MODULE__i18n_tipKeys_js_f7b351c4__.CadTipKey.edit.copy.pendingCount, {
    ...
    entrySelectEntity() {
        ...
        this.mouseTipHelper.addTip(__WEBPACK_EXTERNAL_MODULE__auxiliaryTool_MouseTipHelper_js_0b8aa1a1__.MouseTipId.Edit, __WEBPACK_EXTERNAL_MODULE__i18n_tipKeys_js_f7b351c4__.CadTipKey.edit.copy.pendingCount, {
            count: this.selectedEntities.length
        });
    }
    exitSelectEntity() {
    ...
    entrySpecifyBasePoint() {
        this.mouseTipHelper.addTip(__WEBPACK_EXTERNAL_MODULE__auxiliaryTool_MouseTipHelper_js_0b8aa1a1__.MouseTipId.Edit, __WEBPACK_EXTERNAL_MODULE__i18n_tipKeys_js_f7b351c4__.CadTipKey.edit.copy.basePoint);
        this.inject(this.auxiliaryMouseHelper);
    }
    entrySpecifySecondPoint() {
        this.mouseTipHelper.addTip(__WEBPACK_EXTERNAL_MODULE__auxiliaryTool_MouseTipHelper_js_0b8aa1a1__.MouseTipId.Edit, __WEBPACK_EXTERNAL_MODULE__i18n_tipKeys_js_f7b351c4__.CadTipKey.edit.copy.targetPoint);
    }
    update() {
    ...
    executeOperate() {
        ...
        this.historyManager.addCommandAndExecute(new __WEBPACK_EXTERNAL_MODULE__command_CopyEntityCommand_js_d463eea3__.CopyEntityCommand(this.selectedEntities, {
            translate
        }, this.viewManager));
    }
    constructor(...args){
        super(...args), this.name = __WEBPACK_EXTERNAL_MODULE__container_types_js_b48f778d__.TYPES.CopyEntityTool, this.machine = copyEntityMachine.provide({
            actions: {
...
], CopyEntityTool.prototype, "viewManager", void 0);
_ts_decorate([
...
], CopyEntityTool.prototype, "entitySelector", void 0);
_ts_decorate([
...
], CopyEntityTool.prototype, "mouseTipHelper", void 0);
_ts_decorate([
...
], CopyEntityTool.prototype, "historyManager", void 0);
_ts_decorate([
...
], CopyEntityTool.prototype, "auxiliaryMouseHelper", void 0);
CopyEntityTool = _ts_decorate([
    (0, __WEBPACK_EXTERNAL_MODULE_inversify__.injectable)()
], CopyEntityTool);
export { CopyEntityTool };
