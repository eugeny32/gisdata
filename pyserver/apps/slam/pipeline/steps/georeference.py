...
def run(ctx: dict) -> dict:
    ...
    # scenario needs it.
    raise RuntimeError(
        "PPK-РїСѓС‚СЊ georeference РЅРµ СЂРµР°Р»РёР·РѕРІР°РЅ РІ СЌС‚РѕРј РїРѕСЂС‚Рµ: РЅСѓР¶РЅР° CRS, РІСЃС‚СЂРѕРµРЅРЅР°СЏ РІ "
        "РїСЂРѕРјРµР¶СѓС‚РѕС‡РЅС‹Р№ LAS, Р° las_io.py СЃРѕР·РЅР°С‚РµР»СЊРЅРѕ РµС‘ РЅРµ С…СЂР°РЅРёС‚ (СЃРј. РґРѕРєСЃС‚СЂРёРЅРі). "
        "РђРєС‚СѓР°Р»СЊРЅРѕ С‚РѕР»СЊРєРѕ РґР»СЏ РЅРµ-bag/РІРЅРµС€РЅРёС… PPK-СЃС†РµРЅР°СЂРёРµРІ, РЅРµ РґР»СЏ СЃС‚Р°РЅРґР°СЂС‚РЅРѕРіРѕ РїСѓС‚Рё S20."
    )
