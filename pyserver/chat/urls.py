...
urlpatterns = [
    ...
    path("api/chat/<int:conversation_id>/attach_from_storage/", views.attach_from_storage_view, name="api_chat_attach_from_storage"),
    ...
    path("api/chat/attachments/<int:attachment_id>/save_to_storage/", views.save_attachment_to_storage_view, name="api_chat_attachment_save_to_storage"),
