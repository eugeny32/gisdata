...
in slam_pipeline.pipeline.steps.STEP_FUNCS with no name transformation at
...
from slam_pipeline.pipeline.steps import STEP_FUNCS
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            if func is None:
                raise RuntimeError(f"Нет реализации шага: {step}")
