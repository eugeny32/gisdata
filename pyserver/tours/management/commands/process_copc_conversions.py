...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(f"LAS-файлов в БД: {len(las_files)}, уже запущенных конвертаций (lock): {running_count}")
        ...
        for relative_path in las_files:
            ...
            spawned += 1
            self.stdout.write(f"Запущена конвертация: {relative_path} -> {relative_path}.copc.laz")
